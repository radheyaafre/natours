...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  console.log('show alerts after hide');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              (0, _alerts.showAlert)('success', 'login sucessfully');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); //extend map bounds to incude current locations
...
var stripe = Stripe('pk_test_51HEwGaCrHIvmIQ6PeSfMnYHxjYk6iDtXlLW5PEISLP47bE6mHEYZETbW8V0ymqnW1OtnZocb36wty9O529iTsdHl00NljMIn6z');
